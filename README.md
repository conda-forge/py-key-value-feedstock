...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=26783&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/py-key-value-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Installing `py-key-value` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
```
conda search py-key-value-aio --channel conda-forge
```

or with `mamba`:

```
mamba search py-key-value-aio --channel conda-forge
```
...
mamba repoquery search py-key-value-aio --channel conda-forge

# List packages depending on `py-key-value-aio`:
mamba repoquery whoneeds py-key-value-aio --channel conda-forge

# List dependencies of `py-key-value-aio`:
mamba repoquery depends py-key-value-aio --channel conda-forge
```
...
Updating py-key-value-feedstock
===============================

If you would like to improve the py-key-value recipe or build a new
...
Note that all branches in the conda-forge/py-key-value-feedstock are
